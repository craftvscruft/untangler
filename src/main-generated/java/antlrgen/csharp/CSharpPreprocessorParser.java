...
public class CSharpPreprocessorParser extends CSharpPreprocessorParserBase {
    ...
    public final Preprocessor_directiveContext preprocessor_directive()
        ...
        Preprocessor_directiveContext _localctx =
                new Preprocessor_directiveContext(_ctx, getState());
            ...
            switch (_input.LA(1)) {
                ...
                case IF:
                    ...
                    enterOuterAlt(_localctx, 3);
                    {
                        ...
                        match(IF);
                        setState(17);
                        ((PreprocessorConditionalContext) _localctx).expr =
    ...
    public static class Directive_new_line_or_sharpContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof CSharpPreprocessorParserListener)
                ((CSharpPreprocessorParserListener) listener)
                        .enterDirective_new_line_or_sharp(this);
        }
                    ...
                    case OPEN_PARENS:
                        {
                            ...
                            match(OPEN_PARENS);
                            setState(92);
                            ((Preprocessor_expressionContext) _localctx).expr =
                                    preprocessor_expression(0);
                            setState(93);
                            match(CLOSE_PARENS);
                                ...
                                case 1:
                                    {
                                        ...
                                        match(OP_EQ);
                                        setState(104);
                                        ((Preprocessor_expressionContext) _localctx).expr2 =
                                                preprocessor_expression(5);
